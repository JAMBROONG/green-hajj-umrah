  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-border z-50 shadow-lg">
      <div className="max-w-[430px] mx-auto px-5 py-2 flex justify-around">
        <Link 
          href="/" 
          className={`nav-item flex flex-col items-center gap-1 py-1 px-3 rounded-lg transition-all ${isActive('/') && !pathname.includes('/phases') && !pathname.includes('/carbon-market') && !pathname.includes('/analytics') ? 'active' : ''}`}
        >
