 ...
 * Used by checkout page to compute admin fee + PPN breakdown.
 *
 * Response:
 *   {
 *     idx_admin_fee_pct: 2.5,   // decimal, 0-100
...
export async function GET() {
  try {
    ...
    return NextResponse.json(
      { error: 'Gagal mengambil setting', idx_admin_fee_pct: 0, ppn_pct: 11 },
      { status: 500 }
    )
  }
}
